...
public class ChangePassword  {
    public ChangePassword(User user, Database database){
        ...
        panel.add(new JLabel("Change Password", 40, GUIConstants.blue, Font.BOLD),BorderLayout.NORTH);
        ...
        submit.addMouseListener(new MouseListener() {
            ...
            public void mouseClicked(MouseEvent e) {
                ...
                if(!oldPassword.getText().equals(user.getPassword())){
                    new Alert("old password does't match", frame);
                    return;
                }
                ...
                if(confirmPassword.isEmpty()) {
                    new Alert("Please Enter confirm password", frame);
                    return;
                }
                if(!newPassword.getText().equals(confirmPassword.getText())){
                    new Alert("Password does't match", frame);
                    return;
                }
